...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Set the stretch factor of the horizontal layout
        # self.button_layout.setStretchFactor(1)
        ...
        self.text_line = QLabel(self)
        self.frame_layout.addWidget(self.captured_label,0,1)

        self.count_label = QLabel("")
        self.frame_layout.addWidget(self.count_label,2,0)
